import './Styleshout.scss'

export default function Styleshout() {
    return (
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        ...
                        <a href="https://styleshout.com" target='_blank' className="btn btn-primary btn-lg text-uppercase px-5 mx-3 my-2">
                            Visit Styleshout
                        </a>
                    </div>
                </div>
